...
//O certo seria
console.log(cor);
//unico que sai é o var, se acaso quisesse mostrar todos, basta colocar o consolelog dentro do escopo
...
// basta passar a constante dois para fora:
const dois = 2;
function somarDois(x) {
  return x + dois;
}
...
//Podemos mudar o var numero para let e deixar a variavel numero de fora como uma constante
const numero = 50;
